...
.vds-video-layout {
  ...
  --media-slider-step-color: var(--color-typography-500);
  ...
  /* Menu Text. */
  --media-menu-text-color: var(--color-typography-50);
  --media-menu-text-secondary-color: var(--color-typography-50);
  ...
  --media-menu-scrollbar-thumb-bg: var(--color-typography-50);

  --media-sm-menu-landscape-max-height: min(70vh, 400px);
  --media-sm-menu-portrait-max-height: 40vh;

  /* Menu Section. */
  --media-menu-section-bg: var(--color-surface-100);
  --media-menu-section-border: unset;
  --media-menu-section-divider: var(--color-surface-500);
  ...
  --media-menu-item-hover-bg: var(--color-surface-400);
  --media-menu-item-icon-size: 18px;
  --media-menu-item-icon-spacing: 6px;
  --media-menu-item-padding: 10px;

  /* Menu Radio. */
  --media-menu-radio-icon-color: var(--color-typography-50);
  ...
  /* Chapters Menu. */
  --media-chapters-divider: var(--color-surface-500);
  ...
  --media-chapters-progress-bg: var(--color-typography-50);
