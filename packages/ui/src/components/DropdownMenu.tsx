...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "transition-colors focus:bg-ghost-500 data-[state=open]:bg-ghost-600 flex cursor-pointer items-center rounded-md p-2 text-sm outline-hidden select-none data-[inset]:pl-8",
        className,
      )}
      {...props}
    >
